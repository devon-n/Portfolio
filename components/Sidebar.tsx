...
const Sidebar: React.FC<ISidebarProps> = ({ isCollapsed, setIsCollapsed }) => {
    ...
    return (
        <div className={`py-3 lg:pb-6 flex flex-col items-center transition-all duration-500 relative ${isCollapsed ? 'px-2' : 'px-0'}`}>
            ...
            <div className={`relative transition-all duration-500 ${isCollapsed ? 'w-12 h-12' : 'w-16 h-16 sm:w-20 sm:h-20 lg:w-32 lg:h-32'} mb-1 lg:mb-4 group mt-1 lg:mt-8`}>
